...
export class UsersController {
  ...
  @ApiOperation({
    summary: 'Get clients of a specific manager with pagination and filters',
  })
  ...
  async getManagerClients(
    ...
    return this.usersService.getManagerClients(
      managerId,
      paginationDto,
      filters,
      currentUser,
  ...
  async getManagerClientsChart(
    ...
    return this.usersService.getManagerClientsChart(
      managerId,
      filters,
      currentUser,
    );
  ...
  @ApiOperation({
    summary: 'Get loans of a specific manager with pagination and filters',
  })
  @ApiParam({ name: 'managerId', description: 'Manager ID' })
  @ApiQuery({ name: 'page', required: false, type: Number, example: 1 })
  @ApiQuery({ name: 'limit', required: false, type: Number, example: 10 })
  ...
  async getManagerLoans(
    ...
    return this.usersService.getManagerLoans(
      managerId,
      paginationDto,
      filters,
      currentUser,
  ...
  @ApiOperation({
    summary: 'Get manager loans data for charts (no pagination, reduced data)',
  })
  @ApiParam({ name: 'managerId', description: 'Manager ID' })
  @ApiQuery({
    name: 'clientId',
  ...
  async getManagerLoansChart(
    ...
    return this.usersService.getManagerLoansChart(
      managerId,
      filters,
      currentUser,
    );
