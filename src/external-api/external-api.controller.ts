...
export class ExternalApiController {
  ...
  @ApiOperation({
    summary: 'Fetch and persist current Dólar Blue data from external API',
  })
  @ApiResponse({
    status: 201,
  ...
  @ApiOperation({
    summary: 'Get the latest successful Dólar Blue data from database',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiResponse({
    ...
    schema: {
      type: 'object',
      properties: {
        compra: { type: 'number', example: 1020.5 },
  ...
  @ApiResponse({
    ...
    schema: {
      ...
      properties: {
        data: {
          type: 'array',
          items: { $ref: '#/components/schemas/ExternalApiResponseDto' },
        },
        meta: {
          type: 'object',
          properties: {
  ...
  async getApiResponsesByDateRange(
    ...
    return this.externalApiService.getApiResponsesByDateRange(
      start,
      end,
      pagination,
    );
